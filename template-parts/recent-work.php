...
<section>
        ...
        <div class="container">
            <div class="flex flex-col lg:flex-row items-center py-20 xl:mx-16">
                <div class="flex-1 flex">
                    <img class="mb-5 lg:mb-0 max-w-full lg:max-w-md xl:mx-w-500 w-full rounded-lg" src="<?= get_template_directory_uri()?>/assets/images/project-1.jpg" alt="Find A Job Near You">
                </div>
                <div class="flex-1">
        ...
        <div class="container">
            <div class="flex flex-col-reverse lg:flex-row items-center py-20 xl:mx-16">
                <div class="flex-1 flex order-2 justify-end">
                    <img class="mb-5 lg:mb-0 max-w-full lg:max-w-md xl:mx-w-500 w-full rounded-lg" src="<?= get_template_directory_uri()?>/assets/images/project-2.jpg" alt="Find A Job Near You">
                </div>
    ...
    <div class="relative z-10">
        ...
        <div class="container">
            <div class="flex flex-col lg:flex-row items-center py-20 xl:mx-16">
                <div class="flex-1 flex">
                    <img class="mb-5 lg:mb-0 max-w-full lg:max-w-md xl:mx-w-500 w-full rounded-lg" src="<?= get_template_directory_uri()?>/assets/images/project-4.jpg" alt="Find A Job Near You">
                </div>
                <div class="flex-1">
    ...
    <div class="relative z-10">
        ...
        <div class="container">
            <div class="flex flex-col-reverse lg:flex-row items-center py-20 xl:mx-16">
                <div class="flex-1 flex order-2 justify-end">
                    <img class="mb-5 lg:mb-0 max-w-full lg:max-w-md xl:mx-w-500 w-full rounded-lg" src="<?= get_template_directory_uri()?>/assets/images/project-3.jpg" alt="Find A Job Near You">
                </div>
                <div class="flex-1 order-1">
