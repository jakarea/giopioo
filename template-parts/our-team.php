...
<section class="section-big-padding relative z-10">
    <div class="absolute left-0 right-0 bottom-20 h-full lg:h-2/4 -z-10" style="background-color: #FEF8F3;"></div>
    <div class="container">
        <div class="mb-16 2xl:mb-20">
            <div class="w-20 h-1 bg-giopio-orange mb-4"></div>
            <h2 class="text-giopio-black giopio-title-size font-bold mb-0">Meet Our <span
                    class="inline-block text-giopio-orange">Team</span></h2>
        </div>


        <div class="flex flex-wrap justify-center gap-12 max-w-5xl xl:max-w-7xl mx-auto">
        <?php 
            $args = array(
                'post_type'     => 'team',
                'posts_per_page'=> 3
        ...
        ?>
            <div class="basis-full md:basis-2/5 lg:basis-1/4 mb-14 lg:mb-0 team-member z-10 relative group">
                ...
                if (has_post_thumbnail() ) :     
                    ...
                    <?php the_post_thumbnail( "team-image", 'class=rounded-20 h-5/6 xl:h-full w-full object-cover' ); ?>
                    </div>
            <?php endif ?>
                ...
                <a href="#" class="text-lg font-semibold text-giopio-black mb-1 inline-block duration-500 group-hover:text-white"><?php the_title()?></a>
                <div class="text-base font-medium text-giopio-text duration-500 group-hover:text-white"><?= get_post_meta($post->ID, 'designation', true) ?></div>
    ...
    <div class="text-center pt-6 lg:pt-28">
        <a href="#" class=" text-giopio-orange text-lg font-semibold duration-300 hover:text-giopio-black">See Our
            Full Team</a>
