...
?>
    ...
    <section>
        <div class="container">
                ...
                <?php 
                    ...
                    if($i == 1 || $i == 2){
                        ...
                        <div class="mb-10 group">
                            ...
                            <p class="text-sm font-medium text-giopio-text leading-6">'. get_the_excerpt().'</p>
                        </div>
                    ';    
                    }
                    ...
                    if($i == 3){
                        ...
                        <div class="mb-10 group">
                            <div class="rounded-lg overflow-hidden">
                                <img class="w-full rounded-lg duration-300 group-hover:scale-110" src="'.get_the_post_thumbnail_url(get_the_ID(),'blog-middle-image').'" alt="'.get_the_title().'">
                            </div>
                            <h4 class="text-base font-semibold mt-3 mb-2"><a class="text-giopio-black duration-300 hover:text-giopio-orange" href="'.get_permalink().'">Multi-Level Marketing 1</a></h4>
                            <p class="text-sm font-medium text-giopio-text leading-6">'.get_the_excerpt().'</p>
                        </div>
                    ';    
                    }
            ...
            <div class="md:flex gap-12 xl:mx-36">
